...
const sourceDir = path.resolve(__dirname, '../attacker-packages/@acme/internal-config');
...
console.log('Dependency replaced with attacker-controlled payload. Restart the server to see the effect.');
